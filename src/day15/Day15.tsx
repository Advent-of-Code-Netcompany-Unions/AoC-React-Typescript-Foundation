...
export class Day15 extends React.Component<RouteComponentProps, { input: string; result: string }> {
  ...
  getPartOne(inputGrid: string[]) {
  }

  getPartTwo(inputGrid: string[]) {
  }

  getResult() {
    const inputs = this.state.input.split('\n');
    var res1 = this.getPartOne(inputs);
