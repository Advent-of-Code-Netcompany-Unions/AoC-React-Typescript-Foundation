...
export class Day19 extends React.Component<RouteComponentProps, { input: string; result: string }> {
  ...
  getPartOne(input: string[]) {
  }

  getPartTwo(input: string[]) {
  }

  getResult() {
    const inputs = this.state.input.split('\n');
    let res1 =this.getPartOne(inputs);
    let res2 = this.getPartTwo(inputs);
    this.setState({
